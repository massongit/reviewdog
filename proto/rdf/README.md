...
much welcome. Please leave comments in Pull Request ([#629](https://github.com/massongit/reviewdog/pull/629)),
in issue [#628](https://github.com/massongit/reviewdog/issues/628) or
file [an issue](https://github.com/massongit/reviewdog/issues).

The document and the actual definition are currently under the
https://github.com/massongit/reviewdog repository, but we may create a separate
...
[reviewdog](https://github.com/massongit/reviewdog) resolves the above problem
